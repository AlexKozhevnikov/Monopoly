 ...
 * предложения отвергает, все собственности при возможности покупает, кроме случая, когда у него нет денег - тогда он
 * выставляет их на аукцион. Умеет строить дома и отели и сносить их, когда требуется бабло. По сути, он может выиграть,
 * только если ему по чистой случайности удастся попасть на монополию.
 * Created by akozhevnikov on 19.10.2015.
 */
